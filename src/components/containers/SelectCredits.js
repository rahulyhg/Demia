...
class SelectCredits extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <View style={styles.container}>
        <View>
          ...
          <Text style={styles.infoText}>Includes <Text style={styles.credit}>{this.state.count}</Text> lesson Credits</Text>
        </View>
